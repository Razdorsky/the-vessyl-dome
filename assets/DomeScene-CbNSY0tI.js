...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){let r=new Float32Array(xo),i=new K(0,1,0);return new Yi({name:`SphericalGaussianBlur`,defines:{n:xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Tl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},El=new La(-1,1,1,-1,0,1),Dl=new class extends Dr{constructor(){super(),this.setAttribute(`position`,new X([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new X([0,2,0,0,2,0],2))}},Ol=class{constructor(e){this._mesh=new Xr(Dl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,El)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},kl=class extends Tl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Yi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ki.clone(e.uniforms),this.material=new Yi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ol(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Al=class extends Tl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},jl=class extends Tl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Ml=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new qt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new kl(wl),this.copyPass.material.blending=0,this.timer=new Wa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Al!==void 0&&(r instanceof Al?n=!0:r instanceof jl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Nl={name:`FXAAShader`,uniforms:{tDiffuse:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
		...
		}`},Pl=class extends kl{constructor(){super(Nl)}setSize(e,t){this.material.uniforms.resolution.value.set(1/e,1/t)}},Fl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Il=class extends Tl{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ki.clone(Fl.uniforms),this.material=new Xi({name:Fl.name,uniforms:this.uniforms,vertexShader:Fl.vertexShader,fragmentShader:Fl.fragmentShader}),this._fsQuad=new Ol(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ll=class extends Tl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Rl=Math.PI*2,$=1e-8,zl=1e7,Bl=Math.PI/4,Vl=Math.cos(Bl),Hl=Math.sin(Bl),Ul=new Y(`#30363a`),Wl=new Y(`#76513f`),Gl=new Y(`#d57e3d`),Kl=new Y(`#f5c6a3`),ql=new Y(`#17191a`);function Jl(e,t){return(e%t+t)%t}function Yl(e){return Math.sin(e*12.9898)*43758.5453%1}function Xl(e,t){return{u:e*Vl-t*Hl,s:e*Hl+t*Vl}}function Zl(e){return{p:e.u*Vl+e.s*Hl,q:-e.u*Hl+e.s*Vl}}function Ql(e){let t=[];if(e.forEach(e=>{let n=t[t.length-1];n&&Math.abs(n.u-e.u)<=$&&Math.abs(n.s-e.s)<=$||t.push(e)}),t.length>2){let e=t[0],n=t[t.length-1];Math.abs(e.u-n.u)<=$&&Math.abs(e.s-n.s)<=$&&t.pop()}return t}function $l(e){let t=[];return e.forEach(e=>{let n=t[t.length-1];n&&n.s<=$&&e.s<=$||t.push(e)}),t.length>2&&t[0].s<=$&&t[t.length-1].s<=$&&t.pop(),t}function eu(e,t,n){if(e.length===0)return e;let r=[],i=e[e.length-1],a=n?i.s>=t-$:i.s<=t+$;return e.forEach(e=>{let o=n?e.s>=t-$:e.s<=t+$;if(o!==a){let n=e.s-i.s,a=Math.abs(n)<=$?0:(t-i.s)/n;r.push({u:Dt.lerp(i.u,e.u,a),s:t})}o&&r.push({u:e.u,s:Math.abs(e.s-t)<=$?t:e.s}),i=e,a=o}),Ql(r)}function tu(e,t,n){return eu(eu(e,t,!0),n,!1)}function nu(e){let t=0;for(let n=0;n<e.length;n+=1){let r=e[n],i=e[(n+1)%e.length];t+=r.u*i.s-i.u*r.s}return t*.5}function ru(e){let t=0,n=0,r=0;for(let i=0;i<e.length;i+=1){let a=e[i],o=e[(i+1)%e.length],s=a.u*o.s-o.u*a.s;t+=s,n+=(a.u+o.u)*s,r+=(a.s+o.s)*s}if(Math.abs(t)<=$){let t=e.reduce((e,t)=>(e.u+=t.u,e.s+=t.s,e),{u:0,s:0});return{u:t.u/e.length,s:t.s/e.length}}let i=t*3;return{u:n/i,s:r/i}}function iu(e,t,n,r,i){let a=e.u/t,o=Math.cos(a),s=Math.sin(a);if(e.s<=r+$){let r=Math.min(Math.PI/2,Math.max(0,e.s/t)),a=Math.sin(r),c=Math.cos(r);return i.position.set(t*a*o,n+t*c,t*a*s),i.normal.set(a*o,c,a*s),i}return i.position.set(t*o,n-(e.s-r),t*s),i.normal.set(o,0,s),i}function au(e,t,n){if(e.s<=$)return`apex`;let r=Jl(e.u,t);(r<=$||t-r<=$)&&(r=0);let i=Math.abs(e.s-n)<=$?n:e.s;return`${Math.round(r*zl)}:${Math.round(i*zl)}`}function ou(e,t){return e<t?`${e}|${t}`:`${t}|${e}`}function su(e,t,n){let r=Rl*e,i=n?.16:.115,a=n?32:44,o=n?40:56,s=r/(Math.SQRT2*a),c=r/(Math.SQRT2*o),l=Math.hypot(s,c),u=[{u:0,s:i-l},{u:r,s:i-l},{u:r,s:t+l},{u:0,s:t+l}].map(Zl),d=u.map(({p:e})=>e),f=u.map(({q:e})=>e),p=Math.min(...d),m=Math.max(...d),h=Math.min(...f),g=Math.max(...f),_=Math.floor(h/c)-2,v=Math.ceil(g/c)+2,y=[];for(let e=_;e<=v;e+=1){let n=Jl(e,2)===0?0:.5,a=Math.floor(p/s-n)-2,o=Math.ceil(m/s-n)+2,l=e*c,u=l+c;for(let c=a;c<=o;c+=1){let a=(c+n)*s,o=a+s,d=(a+o)*.5,f=Xl(d,(l+u)*.5);if(f.u<-$||f.u>=r-$)continue;let p=[Xl(a,l),Xl(d,l),Xl(o,l),Xl(o,u),Xl(d,u),Xl(a,u)],m=Math.min(...p.map(({s:e})=>e));if(Math.max(...p.map(({s:e})=>e))<i-$||m>t+$)continue;let h=tu(p,i,t);h.length<3||Math.abs(nu(h))<=$||y.push({points:h,seed:c*.713+e*2.117})}}let b=new Map;y.forEach(({points:e})=>{e.forEach(e=>{if(Math.abs(e.s-i)>$)return;let t=Jl(e.u,r);(t<=$||r-t<=$)&&(t=0);let n=Math.round(t*zl);b.set(n,{u:t,s:i})})});let x=[...b.values()].sort((e,t)=>e.u-t.u),S=[];for(let e=0;e<x.length;e+=1){let t=x[e],n=x[(e+1)%x.length],a={u:e===x.length-1?n.u+r:n.u,s:i};S.push({points:[{u:(t.u+a.u)*.5,s:0},a,t],seed:9e3+e*.917})}return{cells:[...S,...y],circumference:r}}function cu({radius:e,drumHeight:t,springY:n,compact:r}){let i=Math.PI/2*e,a=i+t,{cells:o,circumference:s}=su(e,a,r),c=r?.019:.017,l=r?.014:.012,u=[],d=[],f=[],p=new Map,m=new Map,h={position:new K,normal:new K},g={position:new K,normal:new K},_=new K,v=new K,y=new K,b=(e,t)=>{let n=u.length/3;return u.push(e.x,e.y,e.z),d.push(t.r,t.g,t.b),n},x=t=>{let r=au(t,s,a),o=p.get(r);if(o!==void 0)return o;iu(t,e,n,i,h),h.position.addScaledVector(h.normal,c);let l=b(h.position,ql);return p.set(r,l),l};o.forEach(({points:t,seed:r})=>{let o=$l(t),d=o.map(e=>au(e,s,a));for(let e=0;e<o.length;e+=1){let t=(e+1)%o.length;if(d[e]===d[t])continue;let n=ou(d[e],d[t]),r=m.get(n);r?r.count+=1:m.set(n,{count:1,from:o[e],to:o[t]})}let p=Math.abs(Yl(r)),h=ru(t),S=Dt.clamp(h.s/a,0,1),C=Ul.clone().lerp(Wl,.25+p*.28).lerp(Gl,S*.08+p*.04).lerp(Kl,p>.88?.05:0);iu(h,e,n,i,g),_.copy(g.position).addScaledVector(g.normal,c),v.copy(g.position).addScaledVector(g.normal,c+l);let w=o.map(x),T=w.map(e=>{let t=e*3;return y.set(u[t]-_.x,u[t+1]-_.y,u[t+2]-_.z),y.addScaledVector(g.normal,-y.dot(g.normal)),y.multiplyScalar(.92),b(y.add(v),C)}),E=b(v,C);for(let e=0;e<o.length;e+=1){let t=(e+1)%o.length;f.push(w[e],w[t],T[t],w[e],T[t],T[e],T[e],T[t],E)}});let S=new Dr;S.setAttribute(`position`,new X(u,3)),S.setAttribute(`color`,new X(d,3)),S.setIndex(f),S.computeVertexNormals(),S.computeBoundingBox(),S.computeBoundingSphere();let C=0,w=0,T=0,E=0,D=0;m.forEach(({count:e,from:t,to:n})=>{if(E=Math.max(E,e),e===2){C+=1;return}if(e===1){w+=1,Math.abs(t.s-a)<=$&&Math.abs(n.s-a)<=$||(D+=1);return}T+=1});let O=0;for(let e=0;e<f.length;e+=3){let t=f[e]*3,n=f[e+1]*3,r=f[e+2]*3,i=u[n]-u[t],a=u[n+1]-u[t+1],o=u[n+2]-u[t+2],s=u[r]-u[t],c=u[r+1]-u[t+1],l=u[r+2]-u[t+2],d=a*l-o*c,p=o*s-i*l,m=i*c-a*s;d*d+p*p+m*m<=1e-16&&(O+=1)}return{geometry:S,topology:{tiles:o.length,triangles:f.length/3,vertices:u.length/3,interiorEdges:C,boundaryEdges:w,invalidEdges:T,maxEdgeOwners:E,unexpectedBoundaryEdges:D,zeroAreaTriangles:O}}}function lu(e,t){let n=0,r=1/t,i=e;for(;i>0;)n+=i%t*r,i=Math.floor(i/t),r/=t;return n}function uu(e,t,n){let r=n.domeRadius+n.domeClearance,i=t-n.domeDrumHeight;return t<=n.domeDrumHeight+n.domeClearance?e<=r:i<=r&&e*e+i*i<=r*r}function du(e){let t=new Float32Array(e.count*3),n=0,r=1;for(;n<e.count;){let i=e.fieldRadius*Math.sqrt(lu(r,2)),a=lu(r,3)*Math.PI*2,o=lu(r,5)*e.fieldHeight;if(r+=1,uu(i,o,e))continue;let s=n*3;t[s]=Math.cos(a)*i,t[s+1]=o,t[s+2]=Math.sin(a)*i,n+=1}return t}var fu=t(),pu=new Y(`#d57e3d`),mu=new Y(`#f5c6a3`),hu=new Y(`#2a1309`),gu=2.48,_u=gu*.62,vu=0,yu=vu-_u,bu=vu+gu,xu=1.08,Su=22,Cu=15.5,wu=68,Tu=462863,Eu=1e3/60,Du={fxaa:!0,msaa:!1,msaaSamples:4},Ou=!1,ku={desktop:1.4,tablet:1.4,mobileWide:1.3,mobile:1.2,small:1.2},Au=.065,ju=.2,Mu=.2,Nu=.001,Pu=328,Fu=246,Iu=9,Lu=6,Ru=.08;function zu(e){return Math.sin(e*12.9898)*43758.5453%1}function Bu(e){return e>1100?ku.desktop:e>820?ku.tablet:e>760?ku.mobileWide:e>520?ku.mobile:ku.small}function Vu(e,t){let n=t?42:60,r=t?4:6,i=t?16:24,a=[];for(let t=0;t<=r;t+=1)a.push(new G(e,yu+_u*t/r));for(let t=1;t<=i;t+=1){let n=t/i*(Math.PI/2);a.push(new G(Math.cos(n)*e,vu+Math.sin(n)*e))}let o=new Fi(a,n,0,Math.PI*2),s=o.toNonIndexed(),c=s.getAttribute(`position`),l=[];for(let e=0;e<c.count;e+=3){let t=(c.getX(e)+c.getX(e+1)+c.getX(e+2))/3,n=(c.getY(e)+c.getY(e+1)+c.getY(e+2))/3,r=(c.getZ(e)+c.getZ(e+1)+c.getZ(e+2))/3,i=Math.abs(zu(t*3.1+n*5.7+r*7.3)),a=Dt.clamp((n-yu)/(bu-yu),0,1),o=hu.clone().lerp(pu,.3+i*.34).lerp(mu,a**2.8*.14);for(let e=0;e<3;e+=1)l.push(o.r,o.g,o.b)}return s.setAttribute(`color`,new X(l,3)),s.computeBoundingSphere(),o.dispose(),s}function Hu(e){let t=du({count:e,fieldRadius:Iu,fieldHeight:Lu,domeRadius:gu*xu,domeDrumHeight:_u*xu,domeClearance:Ru}),n=new Dr;return n.setAttribute(`position`,new pr(t,3)),n}function Uu(){let e=31/2,t=new Uint8Array(1024*4);for(let n=0;n<32;n+=1)for(let r=0;r<32;r+=1){let i=Math.hypot(r-e,n-e)/e,a=Dt.clamp((1-i)/.22,0,1),o=a*a*(3-2*a),s=(n*32+r)*4;t[s]=255,t[s+1]=255,t[s+2]=255,t[s+3]=Math.round(o*255)}let n=new $r(t,32,32,D);return n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1,n.needsUpdate=!0,n}function Wu(e,t){let{geometry:n,topology:r}=cu({radius:e,drumHeight:_u,springY:vu,compact:t}),i=new Zi({color:16777215,vertexColors:!0,metalness:.52,roughness:.64,opacity:1,transparent:!0,side:0,depthWrite:!1}),a=new Xr(n,i);return a.userData.claddingTopology=r,{mesh:a,geometry:n,material:i}}function Gu(e,t,n,r){e.copy(t).lerp(n,r)}function Ku(e,t,n,r,i,a){let o=e[0],s=e[e.length-1];for(let n=0;n<e.length-1;n+=1)if(t>=e[n].at&&t<=e[n+1].at){o=e[n],s=e[n+1];break}let c=Math.max(1e-4,s.at-o.at),l=Dt.clamp((t-o.at)/c,0,1),u=l*l*(3-2*l);return Gu(n,o.camera,s.camera,u),Gu(r,o.target,s.target,u),Gu(i,o.dome,s.dome,u),a.scale=Dt.lerp(o.scale,s.scale,u),a.rotation=Dt.lerp(o.rotation,s.rotation,u),a.tiles=Dt.lerp(o.tiles,s.tiles,u),a.shell=Dt.lerp(o.shell,s.shell,u),a.wire=Dt.lerp(o.wire,s.wire,u),a.resonance=Dt.lerp(o.resonance,s.resonance,u),a.sky=Dt.lerp(o.sky,s.sky,u),a}function qu(){let e=(0,n.useRef)(null);return(0,n.useEffect)(()=>{let t=e.current;if(!t)return;let n=document.documentElement,r=window.matchMedia(`(prefers-reduced-motion: reduce)`),a=window.matchMedia(`(max-width: 760px)`),o=window.matchMedia(`(pointer: fine)`),s=navigator.connection,c=r.matches,u=a.matches;s?.saveData||navigator.hardwareConcurrency>0&&navigator.hardwareConcurrency;let f=Ou,p,m=0,h=0,g=0,_=!1,v=!1,b=!1,x=0,S=0,C=0,w=0,T=0,E=0,D=performance.now(),O=performance.now(),k=0,A=0,j=1,ee=0,M=0,te=0,N=0;n.classList.remove(`no-webgl`,`webgl-ready`),delete n.dataset.sceneState,delete n.dataset.sceneEnvironment,delete n.dataset.sceneAntialiasing,delete n.dataset.scenePowerMode;try{p=new Cl({canvas:t,alpha:!0,antialias:Du.msaa,powerPreference:f?`low-power`:`default`}),n.dataset.scenePowerMode=f?`low-power`:`full`}catch{return n.classList.add(`no-webgl`),()=>{n.classList.remove(`no-webgl`,`webgl-ready`)}}p.outputColorSpace=Le,p.toneMapping=4,p.toneMappingExposure=1.05,p.setPixelRatio(Bu(window.innerWidth));let P=new Pn;P.fog=new Nn(461064,.056);let ne=new Pa(38,1,.1,80),re=new qt(1,1,{type:y,samples:Du.msaa?Du.msaaSamples:0}),ie=new Ml(p,re),ae=new Ll(P,ne),oe=new Il,se=new Pl;se.enabled=Du.fxaa,ie.addPass(ae),ie.addPass(oe),ie.addPass(se),n.dataset.sceneAntialiasing=Du.msaa?Du.fxaa?`msaa+fxaa`:`msaa`:Du.fxaa?`fxaa`:`none`;let ce=new Tn;P.add(ce);let F=new ba().load(u?`/the-vessyl-dome/media/arenal-mobile.webp`:`/the-vessyl-dome/media/arenal.webp`,e=>{if(_){e.dispose();return}e.colorSpace=Le,e.minFilter=d,e.magFilter=l,e.anisotropy=Math.min(2,p?.capabilities.getMaxAnisotropy()??1),e.needsUpdate=!0,b=!0,v||(n.classList.remove(`no-webgl`),n.classList.add(`webgl-ready`)),Ye()},void 0,()=>{_||(b=!1,n.classList.remove(`webgl-ready`))});F.colorSpace=Le,F.wrapS=i,F.wrapT=i;let le=new Pi(Su,Su,Cu,u?40:56,1,!0);le.translate(0,Cu/2,0);let ue=new Yi({transparent:!0,depthWrite:!1,side:1,fog:!1,uniforms:{uMap:{value:F},uOpacity:{value:.42},uEnvironmentHeight:{value:Cu},uGroundColor:{value:new Y(Tu)},uTanHalfFov:{value:Math.tan(Dt.degToRad(wu/2))},uPhotoHalfFov:{value:Dt.degToRad(wu/2)},uCaptureOrigin:{value:new K(0,3,7.6)},uTexel:{value:new G(1/(u?900:1800),1/(u?483:966))}},vertexShader:`
        varying vec2 vUv;
      ...
      `}),de=new Xr(le,ue);de.renderOrder=-20,de.frustumCulled=!1,ce.add(de);let fe=new Ni(Su,u?40:64),pe=new Rr({color:Tu,side:2,fog:!1}),me=new Xr(fe,pe);me.rotation.x=-Math.PI/2,me.position.y=-.006,me.renderOrder=-19,ce.add(me);let I=new Tn;I.rotation.order=`YXZ`,P.add(I);let he=new wn;he.position.y=yu,I.add(he),n.dataset.sceneEnvironment=`webgl-cylindrical-skybox`;let ge=Vu(gu,f),_e=new Zi({vertexColors:!0,flatShading:!1,metalness:.86,roughness:.32,transparent:!0,opacity:.94,side:0,emissive:new Y(`#35170a`),emissiveIntensity:.24}),ve=new Xr(ge,_e);ve.castShadow=!1,ve.receiveShadow=!1,I.add(ve);let ye=Wu(gu,f);I.add(ye.mesh);let be=new Yi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uColor:{value:new Y(`#ffd1ad`)},uOpacity:{value:.28}},vertexShader:`
      ...
      `}),xe=new Xr(ge,be);xe.scale.setScalar(1.008),I.add(xe);let Se=new zi(ge),Ce=new ci({color:15845027,transparent:!0,opacity:0,blending:2,depthWrite:!1}),we=new bi(Se,Ce);we.scale.setScalar(1.012),we.visible=!1,I.add(we);let Te=new Rr({color:13991485,transparent:!0,opacity:.055,side:1,blending:2,depthWrite:!1}),Ee=new Xr(ge,Te);Ee.scale.set(.965,.99,.965),I.add(Ee);let De=new Rr({color:13991485,transparent:!0,opacity:.5,blending:2,depthWrite:!1}),Oe=new Xr(new Ri(gu+.035,.022,8,96),De);Oe.rotation.x=Math.PI/2,Oe.position.y=yu+.032,I.add(Oe);let ke=new Xr(new Ri(gu+.27,.008,6,96),De.clone());ke.rotation.x=Math.PI/2,ke.position.y=yu+.014,ke.material.opacity=.18,I.add(ke);let Ae=new Xr(new Ni(gu+.4,72),new Rr({color:922901,transparent:!0,opacity:.62,side:2}));Ae.rotation.x=-Math.PI/2,Ae.position.y=yu+.006,I.add(Ae);let je=new io(10,18,10,64,3298138,1582119);je.position.y=yu+.018;let L=Array.isArray(je.material)?je.material:[je.material];L.forEach(e=>{e.transparent=!0,e.opacity=.22}),I.add(je);let Me=new Tn;Me.renderOrder=1,P.add(Me);let R=[],Ne=f?3:5;for(let e=0;e<Ne;e+=1){let t=new Xr(new Li(gu+Au,gu+Au+ju,72),new Rr({color:e%2==0?13991485:6007223,transparent:!0,opacity:0,blending:2,depthWrite:!1,side:2}));t.rotation.x=-Math.PI/2,t.position.y=.022,t.userData.phase=e/Ne,Me.add(t),R.push(t)}let z=Hu(f?Fu:Pu),Pe=Uu(),B=new xi({color:11127507,size:u?.022:.028,map:Pe,transparent:!0,opacity:.2,depthWrite:!1,blending:2}),V=new Ei(z,B);V.position.y=yu,P.add(V),P.add(new Sa(12377570,526343,.72));let Fe=new za(16762268,2.8);Fe.position.set(-4,6,4),P.add(Fe);let Ie=new Ia(13991485,42,13,1.7);Ie.position.set(3.5,1.2,3.2),P.add(Ie);let Re=new Ia(2390670,16,15,1.8);Re.position.set(-4.5,.3,1.2),P.add(Re);let ze=[{at:0,camera:new K(.15,1.15,7.6),target:new K(1.15,.62,0),dome:new K(1.62,-.38,0),scale:.94,rotation:-.12,tiles:.96,shell:.42,wire:0,resonance:.46,sky:.42},{at:.2,camera:new K(.6,.72,6.3),target:new K(-1.25,.7,0),dome:new K(-1.75,-.2,.15),scale:xu,rotation:.24,tiles:.26,shell:.44,wire:.42,resonance:.92,sky:.2},{at:.4,camera:new K(-.5,4.9,6.4),target:new K(0,-.2,0),dome:new K(1.55,-.78,-.4),scale:.88,rotation:.76,tiles:.05,shell:.36,wire:.62,resonance:1,sky:.1},{at:.6,camera:new K(.2,1.2,7.9),target:new K(-1.7,.45,0),dome:new K(-2.05,-.42,-.6),scale:.76,rotation:1.12,tiles:.08,shell:.22,wire:.46,resonance:.72,sky:.29},{at:.8,camera:new K(-.6,1.4,8.4),target:new K(1.8,.25,0),dome:new K(2.25,-.5,-.8),scale:.68,rotation:1.48,tiles:.14,shell:.2,wire:.35,resonance:.54,sky:.09},{at:1,camera:new K(0,3.8,7.5),target:new K(0,.3,0),dome:new K(0,-.54,0),scale:1.04,rotation:2.05,tiles:.72,shell:.38,wire:.28,resonance:1,sky:.12}],Be=new K,Ve=new K,He=new K,Ue=new K,We={scale:1,rotation:0,tiles:1,shell:1,wire:1,resonance:1,sky:1},Ge=()=>{c||(x=Dt.clamp(window.scrollY/j,0,1),H())},Ke=e=>{c||!o.matches||(C=e.clientX/window.innerWidth-.5,w=e.clientY/window.innerHeight-.5,H())},qe=()=>{if(h=0,!p)return;let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight),n=Bu(e),r=u?47:38;j=Math.max(1,document.documentElement.scrollHeight-t);let i=e!==ee||t!==M,a=n!==te;!i&&!a&&!(i||r!==N)||(a&&(p.setPixelRatio(n),ie.setPixelRatio(n)),i&&(p.setSize(e,t,!1),ie.setSize(e,t)),ee=e,M=t,te=n,N=r,ne.aspect=e/t,ne.fov=r,ne.updateProjectionMatrix(),c?Ye():H())},Je=()=>{_||(window.clearTimeout(g),g=window.setTimeout(()=>{g=0,!h&&(h=window.requestAnimationFrame(qe))},80))};function Ye(){if(!p||_||v)return;let e=A,t=Ku(ze,S,Be,Ve,He,We);ne.position.copy(Be),ne.position.x+=T*.54,ne.position.y-=E*.36,Ve.x+=T*.18,Ve.y-=E*.08,ne.lookAt(Ve),I.position.copy(He),u&&(I.position.x+=.55),I.scale.setScalar(t.scale),I.rotation.y=t.rotation+(c?0:e*.025),I.rotation.z=T*-.024,he.getWorldPosition(Ue),ce.position.y=Ue.y,Me.position.copy(Ue),Me.scale.setScalar(t.scale),Me.rotation.set(0,I.rotation.y,0),V.position.set(I.position.x,Ue.y,I.position.z),_e.opacity=t.shell,ye.material.opacity=t.tiles,ue.uniforms.uOpacity.value=t.sky,_e.emissiveIntensity=.18+t.resonance*.16+(c?0:Math.sin(e*1.1)*.025);let n=Dt.clamp(t.wire,0,1);Ce.opacity=n,we.visible=n>Nu,be.uniforms.uOpacity.value=.16+t.resonance*.24,Te.opacity=.025+t.resonance*.07,Ee.visible=!f,B.opacity=.08+t.resonance*.14,Ie.intensity=30+t.resonance*24+(c?0:Math.sin(e*.8)*3),Ie.position.x=Math.cos(e*.17)*3.8+He.x*.15,Ie.position.z=Math.sin(e*.17)*3.8+2.8,V.rotation.y=S*.45+(c?0:e*.006);for(let n=0;n<R.length;n+=1){let r=R[n],i=c?r.userData.phase:(e*Mu+r.userData.phase)%1,a=1+i*1.88;r.scale.setScalar(a),r.material.opacity=(1-i)*.12*t.resonance}ie.render()}let Xe=e=>{if(m=0,_||v||c){n.dataset.sceneState=`idle`;return}let t=Math.min(100,Math.max(0,e-O));if(O=e,k+=t,k<Eu-.35){m=window.requestAnimationFrame(Xe);return}k%=Eu;let r=Math.min(.08,Math.max(.001,(e-D)/1e3));D=e,A+=r,S=Dt.damp(S,x,5.5,r),T=Dt.damp(T,C,5.8,r),E=Dt.damp(E,w,5.8,r),Ye(),m=window.requestAnimationFrame(Xe)};function Ze(){if(_||v||c||document.hidden||m)return;let e=performance.now();D=e,O=e,k=0,n.dataset.sceneState=`active`,m=window.requestAnimationFrame(Xe)}function H(){Ze()}let U=()=>{document.hidden?(window.cancelAnimationFrame(m),m=0,n.dataset.sceneState=`idle`):!c&&!v&&H()},Qe=e=>{e.preventDefault(),v=!0,window.cancelAnimationFrame(m),m=0,n.classList.remove(`webgl-ready`),n.classList.add(`no-webgl`),n.dataset.sceneState=`idle`},$e=()=>{_||(v=!1,n.classList.remove(`no-webgl`),b&&n.classList.add(`webgl-ready`),ee=0,M=0,te=0,N=0,D=performance.now(),O=D,qe(),Ye(),c||H())},et=e=>{if(c=e.matches,window.cancelAnimationFrame(m),m=0,c){j=Math.max(1,document.documentElement.scrollHeight-window.innerHeight);let e=Dt.clamp(window.scrollY/j,0,1);x=e,S=e,C=0,w=0,T=0,E=0,Ye(),n.dataset.sceneState=`idle`}else v||(Ge(),H())},tt=e=>{u=e.matches,f=Ou,n.dataset.scenePowerMode=f?`low-power`:`full`,Je()};return window.addEventListener(`scroll`,Ge,{passive:!0}),window.addEventListener(`resize`,Je),window.visualViewport?.addEventListener(`resize`,Je),window.addEventListener(`pointermove`,Ke,{passive:!0}),document.addEventListener(`visibilitychange`,U),t.addEventListener(`webglcontextlost`,Qe),t.addEventListener(`webglcontextrestored`,$e),r.addEventListener(`change`,et),a.addEventListener(`change`,tt),qe(),Ge(),Ye(),c?n.dataset.sceneState=`idle`:H(),()=>{_=!0,window.cancelAnimationFrame(m),window.cancelAnimationFrame(h),window.clearTimeout(g),window.removeEventListener(`scroll`,Ge),window.removeEventListener(`resize`,Je),window.visualViewport?.removeEventListener(`resize`,Je),window.removeEventListener(`pointermove`,Ke),document.removeEventListener(`visibilitychange`,U),t.removeEventListener(`webglcontextlost`,Qe),t.removeEventListener(`webglcontextrestored`,$e),r.removeEventListener(`change`,et),a.removeEventListener(`change`,tt),n.classList.remove(`no-webgl`,`webgl-ready`),delete n.dataset.sceneState,delete n.dataset.sceneEnvironment,delete n.dataset.sceneAntialiasing,delete n.dataset.scenePowerMode,R.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),ge.dispose(),ye.geometry.dispose(),ye.material.dispose(),Se.dispose(),z.dispose(),_e.dispose(),Ce.dispose(),be.dispose(),Te.dispose(),Oe.geometry.dispose(),Oe.material.dispose(),ke.geometry.dispose(),ke.material.dispose(),Ae.geometry.dispose(),Ae.material.dispose(),B.dispose(),Pe.dispose(),je.geometry.dispose(),L.forEach(e=>e.dispose()),le.dispose(),ue.dispose(),F.dispose(),fe.dispose(),pe.dispose(),se.dispose(),oe.dispose(),ie.dispose(),p?.dispose()}},[]),(0,fu.jsx)(`canvas`,{ref:e,className:`dome-canvas`})}export{qu as DomeScene};